...
export default function Login() {
  ...
  const { login, loginWithGoogle, loginWithGitHub, isLoading: authLoading } = useAuth();
  ...
  const handleGitHubLogin = async () => {
    ...
    try {
      ...
      toast({ title: "Welcome!", description: "Logged in with GitHub" });
      navigate("/");
    } catch (error) {
      toast({ title: "Error", description: "GitHub login failed", variant: "destructive" });
    } finally {
      setIsLoading(false);
    }
  };
